...
1. [[DevLog/AI自動化Unity工作流整合/Phase-1|#1 兩個工具的合體]] - 兩個工具的整合設計與 async/sync 橋接
2. [[DevLog/AI自動化Unity工作流整合/Phase-2|#2 四階段工作流]] - Jira → AI → Git → 人工審批的端到端流程
3. [[DevLog/AI自動化Unity工作流整合/Phase-3|#3 Tool Use 專案探索]] - Anthropic Tool Use API 讓 AI 真的看懂程式碼
